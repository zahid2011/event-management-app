...
//
//        // Assume that you have a way to get the current user's ID
//        // For example, if you're using Firebase Authentication
//        // String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
//        // For this example, let's assume the user ID is extracted from the QR code scan
//        // Since the user scanned the QR code, we can consider that the user is allowed to register
//
//        // For demonstration purposes, we'll use a placeholder user ID
//        String userId = "scannedUserId"; // Replace with actual user ID retrieval method
//
...
//            // Default constructor required for calls to DataSnapshot.getValue(WaitingListEntry.class)
//        }
//
...
//                                    .set(new WaitingListEntry(userId))
//                                    .addOnSuccessListener(aVoid -> {
//                                        if (geolocationView.isEnabled()) {
//                                            // Show warning popup
//                                            AlertDialog.Builder builder = new AlertDialog.Builder(this);
//                                            builder.setTitle("Geolocation Required")
//                                                    .setMessage("This waiting list requires geolocation. Do you want to proceed?")
